...
const CardScene := preload("res://scenes/inkmon-main/tools/components/inspector_card.tscn")
const KvRowScene := preload("res://scenes/inkmon-main/tools/components/inspector_kv_row.tscn")
