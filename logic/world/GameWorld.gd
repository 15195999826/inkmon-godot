...
func shutdown() -> void:
	for instance in _instances.values():
		if instance != null and instance.has_method("end"):
			instance.end()
	_instances.clear()
	_initialized = false
...
func create_instance(factory: Callable):
	...
	if instance == null or not instance.has("id"):
...
func get_instances_by_type(type_value: String) -> Array:
	var results := []
	for instance in _instances.values():
		if instance != null and instance.has("type") and instance.type == type_value:
			results.append(instance)
		elif instance != null and instance.has_method("type") and instance.type == type_value:
			results.append(instance)
	return results
...
func tick_all(dt: float) -> void:
	for instance in _instances.values():
		if instance != null and instance.has_method("is_running") and instance.is_running():
			instance.tick(dt)
