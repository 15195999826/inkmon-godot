...
| **RTS UI main_menu 冒烟** `addons/logic-game-framework/example/rts-auto-battle/tests/frontend/smoke_ui_main_menu.tscn` | main_menu → demo apply_preset 链路 (M2.3 Phase D); 加载 main_menu, emit 第一个 Button 的 pressed → 验证 demo 加 child + demo._preset 不空 |
