...
func _test_clamping() -> void:
	...
	attr_set.set_base("hp", 200.0)
	TestFramework.assert_near(150.0, attr_set.get_current_value("hp"))
...
func _test_modifier_add_remove() -> void:
	...
	TestFramework.assert_near(60.0, attr_set.get_current_value("attack"))
	TestFramework.assert_true(attr_set.has_modifier("buff"))
	TestFramework.assert_true(attr_set.remove_modifier("buff"))
	TestFramework.assert_near(50.0, attr_set.get_current_value("attack"))
	TestFramework.assert_true(not attr_set.has_modifier("buff"))
