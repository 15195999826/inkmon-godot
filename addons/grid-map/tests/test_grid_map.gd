## GridMap 完整单元测试
##
## 运行方式: godot --headless --script addons/grid-map/tests/test_grid_map.gd
extends SceneTree
...
# 这样可以正确实例化类
var GridMapConfig = load("res://addons/grid-map/core/grid_types.gd")
var GridCoord = load("res://addons/grid-map/core/grid_coord.gd")
var GridMath = load("res://addons/grid-map/core/grid_math.gd")
var GridLayout = load("res://addons/grid-map/core/grid_layout.gd")
var GridMapModel = load("res://addons/grid-map/model/grid_map_model.gd")
var GridPathfinding = load("res://addons/grid-map/pathfinding/grid_pathfinding.gd")
