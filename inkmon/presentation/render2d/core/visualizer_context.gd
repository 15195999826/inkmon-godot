## InkMonRender2DVisualizerContext - Visualizer 的只读上下文
##
...
class_name InkMonRender2DVisualizerContext
extends RefCounted


## 角色状态 Map（actor_id -> InkMonRender2DActorRenderState）
...
func _init(
	...
	animation_config: InkMonRender2DAnimationConfig
) -> void:
	_actors = actors
...
func get_animation_config() -> InkMonRender2DAnimationConfig:
