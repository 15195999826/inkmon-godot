...
- [x] M4-perf-gate done (2026-05-04) — realistic demo p99=28 ms ≤ 30 ms 阈值 → 跳 M4c
- [~] M4c — Dirty 增量 — **CANCEL**(perf-gate 不触发;未来 demo 规模扩大可补)
- [~] ✋2 体验点 — **DEFERRED 到 M5**(依赖 M4b.3 wire 落地;不阻塞 M4 archive)
- [x] M4 整 milestone done + archived (2026-05-04) — `archive/2026-05-04-rts-m3-m4-hierarchical/`
