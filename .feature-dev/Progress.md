...
**Status**: ✅ **Phase A + B + C 收口** (2026-05-02); 🔒 **Phase D pending** (等待用户确认启动)
...
- Phase D: 🔒 pending (等待用户确认启动 — Cost Rebalance + smoke_economy_demo)

最近更新: 2026-05-02 (Phase C 收口: 7/7 AC PASS + 13/13 validation 全过 0 漂移 + simplify pass clean; phase-d-cost-rebalance.md skeleton 落地, 等待用户确认启动 Phase D)
...
详见 [`task-plan/m2-1-economy/phase-d-cost-rebalance.md`](task-plan/m2-1-economy/phase-d-cost-rebalance.md) (Phase C 收口时落 skeleton; AC1-AC5 待用户启动 Phase D 时 finalize 数值与 smoke 设计)。
...
- 用户启动 Phase D 时确认: D17 cost 数值具体配方 / D18 smoke_economy_demo 时长阈值 / D19 demo_rts_frontend 起手 spawn 列表
