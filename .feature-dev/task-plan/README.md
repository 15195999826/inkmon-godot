# Task Plan — Active: RTS Pathfinding M3 Epic / M1 sub-feature

> **Active feature**: M3 Epic — RTS 寻路全面迁移到 0 A.D. 方案;**当前 sub-feature = M1**(Navcell Grid + 16-bit Passability Class)
>
> **Epic 状态**: codex Round 1-8 全部 APPROVE,Step A + Step B 文档体系完整,**M0 已 done + archived**(2026-05-04),M1 等 `/autonomous-feature-runner` 启动
>
...
| [`m3-0ad-pathfinding-migration/milestones/M1-navcell-grid.md`](m3-0ad-pathfinding-migration/milestones/M1-navcell-grid.md) | **当前 sub-feature 完整 spec** | 🟡 active, 待 runner 启动 |
...
**M1 sub-feature 完成标志**(待):
- M1 §3 AC1-AC10 全部 ✅
- Validation 全套 14 项 smoke + LGF 73 + replay seed=42 deep-equal + baseline CSV byte-identical(M1 不引入 trace 新字段)
